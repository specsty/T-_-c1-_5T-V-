...
public class bigJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pilihNumber = new javax.swing.JComboBox<String>();
        signNumber = new javax.swing.JComboBox<String>();
        ...
        jLabel6.setForeground(new java.awt.Color(0, 127, 169));
        jLabel6.setText("Time :");

        operationField.setEditable(false);
        operationField.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        operationField.setEnabled(false);

        jLabel7.setFont(new java.awt.Font("Cantarell", 1, 24)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 127, 169));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(operationField, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jLabel6)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(timeField, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(50, 50, 50))))
        );
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jLabel6)
                            .addComponent(operationField, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel7))
                        .addGap(1, 1, 1)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void kurangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kurangActionPerformed
        ...
        b = new BigNumLib();
        hasil.setText(b.minus(number1.getText(), number2.getText()));
        operationField.setText(b.getCount()+" times");
        long end = System.nanoTime();
        long micro = (end - start) / 1000;
        timeField.setText(micro + " microseconds");
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        long start = System.nanoTime();
        b = new BigNumLib();
        hasil.setText(b.plus(number1.getText(), number2.getText()));
        operationField.setText(b.getCount()+" times");
        long end = System.nanoTime();
        long micro = (end - start) / 1000;
        timeField.setText(micro + " microseconds");
    ...
    private void generaterNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generaterNumberActionPerformed
        ...
        for (int idx = 0; idx < sizeint; idx++){
            int randomNumber = (idx!=0)?random.nextInt(10):random.nextInt(9)+1; 
            s += randomNumber;
        }
       if (pilihNumber.getSelectedIndex()==0) {
           number1.setText(((signNumber.getSelectedIndex()==1)?"-":"") + s);
       } else {
           number2.setText(((signNumber.getSelectedIndex()==1)?"-":"") + s);
       }
    ...
    private void kaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kaliActionPerformed
        long start = System.nanoTime();
        b = new BigNumLib();
        hasil.setText(b.multiply(number1.getText(), number2.getText()));
        operationField.setText(b.getProduct()+" times");
        long end = System.nanoTime();
        long micro = (end - start) / 1000;
        timeField.setText(micro + " microseconds");
